  ...
  return (
    <div className="d-flex flex-column px-3 pt-5 pt-md-0 justify-content-md-center booking-page">
      ...
      <div className="d-flex flex-column ">
        <div className="text-capitalize fs-1 text-success big-text mb-4 text-left text-md-left">
          A good look reflects your story and your spirit
        </div>
        <div className="text-danger fs-5 small-text text-muted text-left text-md-left mb-3 d-flex flex-column">
